...
def testme():
    ...
    mybuck.set_blob_metadata('test/image_orig.jpg', {'Cache-Control': 'public, max-age=300'})    
...
if __name__ == '__main__':
    ...
    group.add_argument("--test", dest="do_test", required=False, action='store_true',
    ...
    group.add_argument("--list", dest="do_list", required=False, action='store_true',
                        help="Do an upload", default=False)
    group.add_argument("--get_metadata", dest="do_get_metadata", required=False, action='store_true',
                        help="Get blob metadata", default=False)
    group.add_argument("--set_metadata", dest="do_set_metadata", required=False, action='store_true',
